...
content_template = """export interface ExternalResource {
  title: string
  url: string
...
with open("c:/Users/HP/Downloads/ai/mobile/src/data/lessonsData.ts", "w", encoding="utf-8") as f:
    f.write(content_template)

with open("c:/Users/HP/Downloads/ai/frontend/src/data/lessonsData.ts", "w", encoding="utf-8") as f:
    f.write(content_template)

print("Lessons enriched successfully!")
