...
export const themes: Theme[] = [
  {
    ...
    nameAr: 'الشبكة السويسرية الأكاديمية',
    colors: {
      bg: '#0F172A',
      surface: '#1E293B',
      surfaceHover: '#334155',
  ...
  },
  {
    id: 'oxford-academic',
    name: 'Oxford Ledger',
    nameAr: 'السجل الأكاديمي الكلاسيكي',
    colors: {
      bg: '#141210',
      surface: '#221E1A',
      surfaceHover: '#322C27',
      ...
      secondary: '#B45309',
      secondaryGlow: 'rgba(180, 83, 9, 0.2)',
      success: '#22C55E',
      error: '#EF4444',
      warning: '#F59E0B',
      text: '#FEF3C7',
  ...
  {
    id: 'mechanical-blueprint',
    name: 'Industrial Blueprint',
    nameAr: 'المخطط الهندسي الصناعي',
    colors: {
      bg: '#0A192F',
      surface: '#112240',
      surfaceHover: '#1D3557',
